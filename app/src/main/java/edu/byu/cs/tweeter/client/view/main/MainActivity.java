 ...
 */
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainPresentor.View {
    ...
    private MainPresentor presentor = new MainPresentor(this);
